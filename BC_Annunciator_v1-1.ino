...
const int Wbeltim = 500;
const int Ebeltim = 500;
...
if ((Wtrip == true) && (Wappr == true) && (Woneshot == false)) {Wlamp = true; Wring = 0; Woneshot = true;}

if ((Wring == 0) || (Wring == 2)) {digitalWrite (10, HIGH); }
   else {digitalWrite (10, LOW); }

if (Wring == 3) {Wbelltim = millis();}
  else if ((millis() - Wbeltim) > Wbelltim) {Wring = ++Wring; Wbelltim = millis(); }
...
if ((Etrip == true) && (Eappr == true) && (Eoneshot == false)) {Elamp = true; Ering = 0; Eoneshot = true;}

if ((Ering == 0) ||(Ering == 2)) {digitalWrite (11, HIGH); }
   else {digitalWrite (11, LOW); }

if (Ering == 3) {Ebelltim = millis();}
  else if ((millis() - Ebeltim) > Ebelltim) {Ering = ++Ering; Ebelltim = millis(); }
